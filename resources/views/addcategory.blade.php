...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/jquery.bootstrap-datepicker.min.css') }}">
...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="({{ URL::asset('images/logo-text.png') }})" alt="homepage" class="light-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="({{ URL::asset('images/1.jpg') }})" alt="user" class="rounded-circle" width="31"></a>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action="{{ url('addcategory')  }}" method="post">{{ csrf_field() }}
                                <div class="card-body">
                                    <h4 class="card-title">Add Category</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Category Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="category_name" id="fname" placeholder="Category Name Here">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="url" class="form-control" id="cono1" placeholder="URL Here">
                                        </div>
                                    </div>
            ...
            <footer class="footer text-center">
                All Rights Reserved by Asmita Neupane. Designed and Developed by <a href="https://www.asmitaneupane.com.np">Asmita Neupane</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    <script src="{{ asset('js/popper.min.js') }}../../assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="{{ asset('js/bootstrap.min.js') }}../../assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{ asset('js/perfect-scrollbar.jquery.min.js') }}"></script>
    <script src="{{ asset('js/sparkline.js') }}../../assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    ...
    <script src="{{ asset('js/custom.min.js') }}../../assets/libs/jquery-asGradient/dist/jquery-asGradient.js"></script>
    <script src="{{ asset('js/custom.min.js') }}../../assets/libs/jquery-asColorPicker/dist/jquery-asColorPicker.min.js"></script>
    <script src="{{ asset('js/custom.min.js') }}../../assets/libs/jquery-minicolors/jquery.minicolors.min.js"></script>
    <script src="{{ asset('js/custom.min.js') }}../../assets/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="{{ asset('js/custom.min.js') }}../../assets/libs/quill/dist/quill.min.js"></script>
    <script>
        //***********************************//
        // For select 2
        //***********************************//
